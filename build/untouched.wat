(module
 ...
 (data (i32.const 448) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\04\00\00\02\00\00\00")
 (table $0 1 funcref)
 ...
 (export "getStackValue" (func $assembly/index/getStackValue|trampoline))
 ...
 (func $~lib/array/Array<i32>#constructor (; 16 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/array/Array<i32>#push (; 24 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<i32>#pop (; 25 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=12
 ...
 (func $~lib/array/Array<i32>#get:length (; 27 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load offset=12
 )
 (func $~lib/array/Array<i32>#__unchecked_get (; 28 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.load offset=4
  local.get $1
  i32.const 2
 ...
 (func $~lib/array/Array<i32>#__get (; 29 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  local.get $1
  local.get $0
  i32.load offset=12
 ...
 (func $assembly/index/getStackValue (; 30 ;) (param $0 i32) (result i32)
  global.get $assembly/index/stack
  global.get $assembly/index/stack
 ...
 (func $~lib/array/Array<i32>#__visit_impl (; 34 ;) (param $0 i32) (param $1 i32)
  nop
 )
 ...
 (func $assembly/index/getStackValue|trampoline (; 36 ;) (param $0 i32) (result i32)
  block $1of1
   block $0of1
    block $outOfRange
  ...
  local.get $0
  call $assembly/index/getStackValue
 )
